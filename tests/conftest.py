...
# WARNING: Ensure imports from `gw_cloud_ci` comes after this line
from gw_cloud_ci import app, settings, db  # noqa
from gw_cloud_ci.cli import create_user, cli  # noqa
